...
func DumpEnvironmentVariables() {
	println(fmt.Sprintf("TraceShowStacktrace=%t", TraceShowStacktrace))
	println(fmt.Sprintf("TraceShowArbOSRead=%t", TraceShowArbOSRead))
	println(fmt.Sprintf("TraceShowDeepstate=%t", TraceShowDeepstate))
	println(fmt.Sprintf("TraceShowBurn=%t", TraceShowBurn))
	println(fmt.Sprintf("TraceShowOpcodes=%t", TraceShowOpcodes))
	println(fmt.Sprintf("TraceShowStateRootChange=%t", TraceShowStateRootChange))
}
